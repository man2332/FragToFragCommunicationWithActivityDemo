...
public class FragmentA extends Fragment {
    ...
    public interface FragmentAListener {
        void onInputASent(CharSequence input);//CharSequence is more general for text-so we don't have to transform it to a string....
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        buttonOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                listener.onInputASent(input);//this call will be sent to whoever implements our interface
            }
        });
